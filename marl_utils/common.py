...
def parse_args():
    ...
    parser.add_argument('--gated-arch', type=str, default='parallel', choices=['parallel', 'sequential'],
                        help='parallel: GatedSpatioTemporalQ (branch fusion); '
                             'sequential: CommGatedGNNLSTMQ (GNN->LSTM backbone, communication-gated)')
